...
public class MainFrame extends JFrame {
    ...
    private JButton addBtn, updateBtn, visualizeBtn, commandsBtn;
    private int languageIndex = 0;
    private String username, hashPassword;
    private Client client;
    private Integer movieTableCount = 0;

    public MainFrame(String username, String hashPassword, Client client) {
        this.username = username;
        this.client = client;
        this.hashPassword = hashPassword;
        // Загрузка начального языкового пакета (русский язык)
        loadResourceBundle(new Locale("ru", "RU"));
        visualizationWindow = new VisualizationWindow(collection);
    }
    ...
    private void showUpdateMovieDialog() {
        UpdateMovieDialog updateDialog = new UpdateMovieDialog(this, messages, username, hashPassword, client);
        updateDialog.setVisible(true);
    }
    private void showAddMovieDialog() {
        AddMovieDialog dialog = new AddMovieDialog(this, messages, username, hashPassword, client);
        dialog.setVisible(true);
    }

    private void showCommandsDialog() {
        CommandsDialog commandsDialog = new CommandsDialog(this, messages, username, hashPassword, collection, client);
